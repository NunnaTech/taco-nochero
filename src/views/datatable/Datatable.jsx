            ...
            <div className="navbar  shadow-lg px-5 text-neutral-content rounded-box py-5">
                ...
                <div className="flex-none mx-3">
                    <div className="relative">
                        <input type="text" placeholder="Search" className="w-full pr-16 input input-bordered p-2" style={{ color: 'F57C00' }} />
                                ...
                                data.map((i, key) => {
                                    return (
                                        <tr className="hover" key={key}>
                                            ...
                                            {
                                                i.price > 0 && i.price < 100 ? (<td align="center" ><h6 style={{ backgroundColor: "#1D9B28", borderRadius: 15, padding: 6 }}>{i.price}</h6></td>) :
                                                    i.price >= 100 && i.price < 300 ? (<td align="center" ><h6 style={{ backgroundColor: "#F96300", borderRadius: 15, padding: 6 }}>{i.price}</h6></td>) :
                                                        i.price >= 300 ? (<td align="center" ><h6 style={{ backgroundColor: "#C11616", borderRadius: 15, padding: 6 }}>{i.price}</h6></td>) : (<></>)
                                            }
                                            <td align="center">{i.category}</td>
                                            <td align="center">
                                                <button className="btn space-x-2" style={{ backgroundColor: "#F57C00" }}>Ver detalles</button>
                                                <button className="btn  space-x-2" style={{ backgroundColor: "#F57C00" }} >
